...
{
    private static readonly Meter Meter = new("LupiraMtgApi.Depz");

    private static readonly Histogram<double> ProbeDuration =
        Meter.CreateHistogram<double>("mtg.dependency.probe.duration", unit: "s");
    ...
    public static void ObserveUpFrom(DependencyReportCache cache) =>
        Meter.CreateObservableGauge("mtg.dependency.up", () =>
